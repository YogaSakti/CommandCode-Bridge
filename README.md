...
Stored files use `commandcode-bridge-<12-hex-fingerprint>.json`. Raw keys, auth JSON, paths, auth indexes, and Authorization headers are excluded from plugin responses and logs.
